...
* The approach entails automatic extraction of QCL prpoerties of interest form scientific literature based on a fine-tuned LLM  and population of the QCL ontology model with the extracted properties to generate the KG.
